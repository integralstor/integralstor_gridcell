...
urlpatterns = patterns('',
    ...
    url(r'^change_admin_password/', require_login(change_admin_password),name="change_admin_password"),
    url(r'^create_snapshot/', require_login(create_snapshot)),
    url(r'^delete_snapshot/', require_login(delete_snapshot)),
    url(r'^restore_snapshot/', require_login(restore_snapshot)),
    ...
    url(r'^show/([A-Za-z0-9_]+)/([a-zA-Z0-9_\-\.]*)', require_login(show),name="show_page"),
