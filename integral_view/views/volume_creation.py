    ...
    try:
        ...
        if action == "select_vol_type":
            ...
            if form.is_valid():
                ...
                form = integral_view.forms.volume_creation_forms.VolTypeForm(
                    initial=init)
      ...
      '''
            ...
            if form.is_valid():
                ...
                init = {}
                init["vol_name"] = vol_name
                form = integral_view.forms.volume_creation_forms.VolAccessMethodForm(
                    initial=init)
                url = "vol_create_wiz_vol_access.html"
            else:
                url = "vol_create_wiz_vol_name.html"
            ...
            if form.is_valid():
                ...
                form = integral_view.forms.volume_creation_forms.ReplicationCountForm(
                    vol_name=cd['vol_name'], vol_type=cd["vol_type"])
