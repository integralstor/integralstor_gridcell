# Django settings for integral-view project.
...
PRODUCTION = False
DEVEL_APP_ROOT = ''
PRODUCTION_APP_ROOT = '/opt/fractalio/integral-view'
APP_NAME = 'integral-view'
...
if PRODUCTION:
  ...
  NTP_CONF_PATH = '/etc'
  ALERTS_URL = "integral-view.fractal.lan"
  AUDIT_URL = "integral-view.fractal.lan"
else:
...
DATABASES = {
    'default': {
        ...
        'NAME': '%s/integral-view.db'%DB_LOCATION,                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'cxxo99@m#_g$dj6h=tx0x(e%4-d1)qtdjf3_6=v54bo!w*ocf^'
...
ROOT_URLCONF = 'integral-view.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'integral-view.wsgi.application'
