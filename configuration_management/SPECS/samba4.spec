...
%define samba_version 4.%{alpha_version}
%define tarball_name samba-4.1.0
...
BuildRequires: pam-devel, readline-devel, ncurses-devel, libacl-devel, e2fsprogs-devel,python-devel
...
%changelog
* Mon Dec 16 2013 Harish Badrinath <harishbadrinath@gmail.com> - 0:4.1.0-0.1.alpha6
