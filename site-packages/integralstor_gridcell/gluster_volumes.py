  ...
  try:
    ...
    if vol_info_dict["replica_count"] > 1:
      ...
      if num_down > 0:
        ...
        return_dict["data_access_status"] = "Healthy"
        return_dict["data_access_status_code"] = 0
    return_dict["size_total"] = filesize.naturalsize(size_total)
    return_dict["size_used"] = filesize.naturalsize(size_total-size_free)
    return_dict["size_free"] = filesize.naturalsize(size_free)
