...
def load_iscsi_volumes_list(vil):
  ...
  try:
    ...
    if err:
      raise Exception(err)
    il, err = db.read_multiple_rows(db_path, "select * from iscsi_volumes")
    if err:
      raise Exception(err)
    if il:
      for i in il:
...
def add_iscsi_volume(vol_name):
  ...
  try:
    ...
    if err:
      raise Exception(err)
    d, err = db.read_single_row(db_path, "select * from iscsi_volumes where vol_name=\'%s\'"%vol_name)
    if err:
      raise Exception(err)
    if d:
      return
...
def load_targets_list():
  ...
  try:
    ...
    if err:
      raise Exception(err)
    iscsi_target_list, err = db.read_multiple_rows(db_path, "select * from iscsi_targets")
    if err:
      raise Exception(err)
  except Exception, e:
...
def load_target_info(index):
  ...
  try:
    ...
    if err:
      raise Exception(err)
    d, err = db.read_single_row(db_path, "select * from iscsi_targets where id=\'%d\'"%index)
    if err:
      raise Exception(err)
  except Exception, e:
...
def delete_target(id):
  ...
  try:
    ...
    if err:
      raise Exception(err)
    ret, err = db.execute_iud([(db_path, "delete from iscsi_targets where id = \'%d\'"%id,)])
    if err:
      raise Exception(err)
  except Exception, e:
...
def load_initiators_list():
  ...
  try:
    ...
    if err:
      raise Exception(err)
    iscsi_initiator_list, err = db.read_multiple_rows(db_path, "select * from iscsi_initiators;")
    if err:
      raise Exception(err)
  except Exception, e:
    return None, str(e)
...
def load_initiator_info(index):
  ...
  try:
    ...
    if err:
      raise Exception(err)
    d, err = db.read_single_row(db_path, "select * from iscsi_initiators where id=\'%d\'"%index)
    if err:
      raise Exception(err)
  except Exception, e:
    return None, ' : %s'%str(e)
...
def create_iscsi_initiator(initiators, auth_network, comment):
  ...
  try:
    ...
    if err:
      raise Exception(err)
    d, err = db.read_single_row(db_path, "select * from iscsi_initiators where auth_network = \'%s\' and initiators=\'%s\'"%(initiators.lower(), auth_network.lower()))
    if err:
      raise Exception(err)
    if d:
      raise Exception("An initiator with the same parameters (with ID %d) already exists"%d["id"])
...
def delete_initiator(id):
  ...
  try:
    ...
    if err:
      raise Exception(err)
    ret, err = db.execute_iud(db_path,[("delete from iscsi_initiators where id = %d"%id,)])
    if err:
      raise Exception(err)
  except Exception, e:
...
def load_auth_access_group_list():
  ...
  try:
    ...
    if err:
      raise Exception(err)
    iscsi_auth_access_group_list, err = db.read_multiple_rows(db_path, "select * from iscsi_auth_access_groups")
  except Exception, e:
...
def load_auth_access_users_list():
  ...
  try:
    ...
    if err:
      raise Exception(err)
    iscsi_auth_access_users_list, err = db.read_multiple_rows(db_path, "select * from iscsi_auth_access_users")
    if err:
      raise Exception(err)
  except Exception, e:
...
def load_auth_access_users_info(auth_access_group_id):
  ...
  try:
    ...
    if err:
      raise Exception(err)
    l, err = db.read_multiple_rows(db_path, "select * from iscsi_auth_access_users where auth_access_group_id = \'%d\'"%auth_access_group_id)
    if err:
      raise Exception(err)
  except Exception, e:
...
def load_auth_access_user_info(user_id):
  ...
  try:
    ...
    if err:
      raise Exception(err)
    d, err = db.read_single_row(db_path, "select * from iscsi_auth_access_users where id = \'%d\'"%user_id)
  except Exception, e:
...
def delete_all_auth_access_groups():
  try:
    ...
    if err:
      raise Exception(err)
    ret, err = db.execute_iud(db_path, [("delete from iscsi_auth_access_groups",)])
    if err:
      raise Exception(err)
  except Exception, e:
...
def delete_all_auth_access_users():
  try:
    ...
    if err:
      raise Exception(err)
    ret, err = db.execute_iud(db_path, [("delete from iscsi_auth_access_users",)])
    if err:
      raise Exception(err)
  except Exception, e:
...
def load_global_target_conf():
  ...
  try:
    ...
    if err:
      raise Exception(err)
    igt, err  = db.read_single_row(db_path, "select * from iscsi_global_target_conf where id = 2")
    if err:
      raise Exception(err)
  except Exception, e:
...
def save_global_target_conf(cd):
  try:
    ...
    if err:
      raise Exception(err)
    igt, err  = db.read_single_row(db_path, "select * from iscsi_global_target_conf where id = \'1\'")
    if err:
      raise Exception(err)
    if not igt:
