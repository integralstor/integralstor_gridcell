import pprint, os, sys, re, subprocess, shutil
...
def get_luns_on_subpath(subpath):
  #Given a subpath, return all LUNs that have that path prefix. Used to find LUNs on a pool
  l = []
  try:
...
def main():
  #targets, err = del_lun('com.integralstor.integralstor-gridcell:anand.test.target','/dev/zvol/pool1/disk1') 
  #targets, err = get_targets()
  ...
  #print _generate_targets_conf()
  '''
  #targets, err = _load_targets_conf()
  pp = pprint.PrettyPrinter(indent=4)
  pp.pprint(targets)
  '''
