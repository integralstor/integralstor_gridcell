...
def setup_cron(client, hostname_list, admin_gridcells = False):
  try :
    jobs = [ 
      ...
      ['*','5','*','*','*','/usr/bin/python /opt/integralstor/integralstor_gridcell/scripts/python/log_backup.py backup_gridcell_logs > /tmp/gridcell_log_backup_output >> /tmp/gridcell_log_backup_errors'], 
